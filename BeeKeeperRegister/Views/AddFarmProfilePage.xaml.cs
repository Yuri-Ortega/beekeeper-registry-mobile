...
public partial class AddFarmProfilePage : ContentPage
{
    public AddFarmProfilePage(AddFarmProfileViewModel vm)
	{
		InitializeComponent();
		BindingContext = vm;
    ...
    {
        if (BindingContext is AddFarmProfileViewModel vm)
        {
            ...
            if (currentStep == 4)
            {
                await vm.AddFarmCommand.ExecuteAsync(null);
    ...
    async Task UpdateSteps()
    {
        ...
        step5.BackgroundColor = currentStep >= 4 ? activeColor : inactiveColor;
        step5Txt.TextColor = currentStep >= 4 ? activeTextColor : inactiveTextColor;
        ...
        line4.BackgroundColor = currentStep >= 4 ? activeColor : inactiveColor;
        ...
        await AnimateStep(step5, currentStep == 4);
